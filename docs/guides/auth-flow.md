...
> ⚠️ Auth пока не реализован в коде. Этот документ описывает целевой дизайн аутентификации для будущей реализации.

Этот гайд описывает, как будет устроена аутентификация в приложении, и что нужно
